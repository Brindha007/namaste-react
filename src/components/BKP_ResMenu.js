          ...
          <li key={menuItems?.card?.info?.id}>
            <div className="flex justify-between m-5">
              <div className="menu-items">
                ...
                <h2 className="font-normal">
                  {menuItems?.card?.info?.ratings?.aggregatedRating?.rating} (
                  {
                    menuItems?.card?.info?.ratings?.aggregatedRating
                      ?.ratingCountV2
                  }
                  )
                </h2>
              ...
              <div className="image-menu">
                <img
                  className="rounded-lg w-[140px] h-[150px] "
                  alt="No image"
                  src={MENU_LIST_IMG + menuItems?.card?.info?.imageId}
                ></img>
                <button className="rounded-lg border text-green-700 w-20 h-10 font-bold mx-7 ">
                  ADD
                </button>
              </div>
            </div>
