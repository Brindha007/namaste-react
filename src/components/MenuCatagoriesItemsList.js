        ...
        >
          <div className="w-9/12">
            <div className="py-2 font-bold">
              ...
              <span> ₹{item.card.info.price / 100}</span> <br></br>
              {item.card.info.ratings.aggregatedRating.rating && <span className="font-bold text-xs text-green-950 ">
